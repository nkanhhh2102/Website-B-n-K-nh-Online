        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                if (isset($_GET['act'])) {
                    ...
                    $sql1 = "SELECT SUM(total_amount) as total_amount FROM orders";
                    $sql2 = "SELECT COUNT(id) as total_order FROM orders";
                    $sql3 = "SELECT SUM(quantity) as total_product FROM order_detail";
                    $sql4 = "SELECT P.*, SUM(D.quantity) as total_unit FROM orders AS O INNER JOIN order_detail AS D ON O.id = D.order_id INNER JOIN products AS P ON D.product_id = P.id GROUP BY P.id ORDER BY total_unit DESC LIMIT 5";
                    $sql5 = "SELECT MONTH(order_date) as month, SUM(total_amount) as total_amount FROM orders GROUP BY MONTH(order_date)";
                    $sql6 = "SELECT MONTH(order_date) as month, COUNT(id) as total_order FROM orders GROUP BY MONTH(order_date)";
                    $sql7 = "SELECT MONTH(O.order_date) as month, SUM(D.quantity) as total_product FROM order_detail AS D INNER JOIN orders AS O ON D.order_id = O.id GROUP BY MONTH(O.order_date)";
